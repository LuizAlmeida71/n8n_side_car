...
# As funções auxiliares (parse_mes_ano, extract_unidade_setor_from_text, etc.)
# permanecem as mesmas da versão anterior. Vou incluí-las para o código ser completo.
...
async def normaliza_escala_from_pdf(request: Request):
    try:
        ...
        # --- PRIMEIRA PASSADA: Coleta de dados globais e conteúdo das tabelas ---
        for page_data in body:
            ...
            with fitz.open(stream=pdf_bytes, filetype="pdf") as doc:
                ...
                # Tenta extrair informações globais a cada página
                ...
                # Armazena o conteúdo das tabelas para processamento posterior
        ...
        # --- VALIDAÇÃO ---
        # Após a primeira passada, verifica se as informações essenciais foram encontradas.
        ...
        # --- SEGUNDA PASSADA: Processamento das tabelas ---
        all_professionals_map = {}
        for page in pages_content:
            all_rows = page["rows"]
            # Usa o setor da página se existir, senão o global
            ...
            while i < len(all_rows):
                ...
                if is_valid_professional_name(nome_raw):
                    ...
                    if nome_key not in all_professionals_map:
                        ...
                        existing["plantoes"].sort(key=lambda p: (p["dia"], p.get("inicio", "")))
                        # Se o setor da página atual for mais específico, atualiza
